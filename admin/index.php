    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <a class="collapse-item" href="?page=Tabungan_Masuk">Tabungan Masuk</a>
                    <a class="collapse-item" href="?page=Tabungan_Keluar">Tabungan Keluar</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="?page=Data_Nasabah">
            ...
            <li class="nav-item">
                <a class="nav-link" href="?page=#">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Tidak Menabung</span></a>             
            </li>

            <li class="nav-item">
                <a class="nav-link" href="?page=#">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Nasabah Lulus/Keluar</span></a>             
            </li>

            <li class="nav-item">
                <a class="nav-link" href="?page=#">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Saldo Nasabah</span></a>             
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseRekapPembayaran"
                    aria-expanded="true" aria-controls="collapseRekapPembayaran">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Rekap Pembayaran</span>
                </a>
                <div id="collapseRekapPembayaran" class="collapse" aria-labelledby="RekapTabungan" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="?page=#">Lihat Transaksi</a>
                        <a class="collapse-item" href="?page=#">Lihat Saldo</a>
                    </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseHistory" class="collapse" aria-labelledby="History" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="?page=Nasabah">Nasabah</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- <a class="navbar-brand brand-logo" href="index.php"><img src="../assets/img/makima.png" alt="logo" /></a> -->
                </div>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../assets/faces/Jihyo.jpg" alt="image">
                                        <div class="status-indicator bg-success"></div>
                                    </div>
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">Jihyo send you a message.</div>
                                        <div class="small text-gray-500">Jihyo · 10m</div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../assets/faces/Sana.jpg" alt="image">
                                        <div class="status-indicator bg-info"></div>
                                    </div>
                                    <div>
                                        <div class="text-truncate">Sana send you a message.</div>
                                        <div class="small text-gray-500">Sana · 20m</div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../assets/faces/Dahyun.jpg" alt="image">
                                        <div class="status-indicator bg-warning"></div>
                                    </div>
                                    <div>
                                        <div class="text-truncate">Dahyun change Profile picture.</div>
                                        <div class="small text-gray-500">Dahyun · 30m</div>
                                    </div>
                                </a>
                                <!-- <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
