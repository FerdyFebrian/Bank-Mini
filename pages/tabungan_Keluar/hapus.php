...
<a class="delete" href="index.php?page=Tabungan_Keluar&hermes=proses_hapus&id=<?php echo $ID_TRANSAKSI;?>&nasabah=<?php echo $DATA['id_nasabah'];?>"> Hapus </a>|
<a class="delete" href="index.php?page=Tabungan_Keluar">Batal</a>