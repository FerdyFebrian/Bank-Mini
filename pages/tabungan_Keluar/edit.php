...
<div class="card card-primary">
  ...
  <form id="quickForm" method="post">
    <div class="container-fluid">
        <!-- SELECT2 EXAMPLE -->
            <div class="row">
              ...
              <input type="hidden" name="Id_Transaksi" class="form-control" id="Id_Transaksi" value="<?php echo $ID_TRANSAKSI;?>" readonly>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="Kode">Kode Transaksi</label>
                  <input type="text" name="Code" class="form-control" id="Code" value="<?php echo $CODE ?>" readonly>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
    ...
    <div class="card-footer">
      ...
      <a href="index.php?page=Tabungan_Keluar" nama="Cancel" class="btn btn-warning">Cancel</a>
    </div>
  </form>
</div>